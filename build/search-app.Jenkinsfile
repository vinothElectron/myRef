	...
	stages {
		stage('ECR/Docker login'){ 
			steps {
				...
				sh 'docker pull $DOCKER_ECR_ROOT/hcl/search-app:9.1.8.0'  
				sh 'docker tag $DOCKER_ECR_ROOT/hcl/search-app:9.1.8.0 hcl/search-app:9.1.8.0'
			}
		}

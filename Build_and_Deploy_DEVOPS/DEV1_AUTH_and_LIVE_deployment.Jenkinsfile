	...
	stages {
		...
		stage('AUTH WCBDataload'){ 
			steps {
				...
				build job: "Run_WCBDataLoad" , parameters: [string(name: 'Env_name', value: "dev1"), string(name: 'Env_type', value: "auth"),string(name: 'branchName', value: "${BRANCH_NAME}")] 
		...
		stage('AUTH deploy'){
			steps {
				...
				build job: "Tag_and_Deployment" , parameters: [string(name: 'Env_name', value: "dev1"), string(name: 'Env_type', value: "auth"), string(name: 'BranchName', value: "${BRANCH_NAME}")]
		...
		stage('AUTH Cache Clear'){
			steps{
				build job: "Clear-Cache" , parameters: [string(name: 'ENVIRONMENT', value: "dev1"), string(name: 'ENVTYPE', value: "auth"), string(name: 'CLEAR_ALL', value: "true"), string(name: 'CACHE_APP_DOMAIN', value: "cache-hp2b-dev1auth.corp.hpicloud.net")]
		...
		stage('LIVE WCBDataload'){ 
			steps {
				...
				build job: "Run_WCBDataLoad" , parameters: [string(name: 'Env_name', value: "dev1"), string(name: 'Env_type', value: "live"),string(name: 'branchName', value: "${BRANCH_NAME}")] 
		...
		stage('LIVE deploy'){
			steps {
				...
				build job: "Tag_and_Deployment" , parameters: [string(name: 'Env_name', value: "dev1"), string(name: 'Env_type', value: "live"), string(name: 'BranchName', value: "${BRANCH_NAME}")]
				echo 'AUTH Tag and deployment completed'
				sleep(time:5,unit:"MINUTES")
				}
			}
		...
		stage('LIVE Cache Clear'){
			steps{
				build job: "Clear-Cache" , parameters: [string(name: 'ENVIRONMENT', value: "dev1"), string(name: 'ENVTYPE', value: "live"), string(name: 'CLEAR_ALL', value: "true"), string(name: 'CACHE_APP_DOMAIN', value: "cache-hp2b-dev1live.corp.hpicloud.net")]
